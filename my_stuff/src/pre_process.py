...
def image_train(resize_size=75, crop_size=70):
#  normalize = transforms.Normalize(mean=[1.026, 1.564, 16.542],
#                                   std=[2.163, 3.260, 33.950])
...
def image_test(resize_size=75, crop_size=70):
#  normalize = transforms.Normalize(mean=[1.026, 1.564, 16.542],
#                                   std=[2.163, 3.260, 33.950])
...
def image_test_10crop(resize_size=75, crop_size=70):
#  normalize = transforms.Normalize(mean=[1.026, 1.564, 16.542],
#                                   std=[2.163, 3.260, 33.950])
  #ten crops for image when validation, input the data_transforms dictionary
#  start_first = 0
